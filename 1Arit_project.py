...
#on doit obtenir "WATCHINGGIRLSGOPASSINGBYITAINTTHELATESTTHINGIMJUSTSTANDINGINADOORWAYIMJUSTTRYINGTOMAKESOMESENSEOUTOFTHESEGIRLSGOPASSINGBYTHETALESTHEYTELLOFMENIMNOTWAITINGONALADYIMJUSTWAITINGONAFRIEND"


#chiffreur2 = Algo2(n=7, offset=8)
#print(chiffreur2.chiffrer("MEETMEATMIDNIGHTBYTHEOLDCLOCKTOWER"))

#print(chiffreur2.dechiffrer("MBKTETYCTEAHTOOETGHLWMMIECEINODRDL"))